...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Не получилось войти, проверьте свои email и пароль', 'danger')
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Ваши данные обнавлены', 'success')
...
def update_post(post_id):
    ...
    return render_template('create_post.html', title='Редактируем пост', form=form, legend='Обновили пост')
